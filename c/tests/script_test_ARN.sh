...
# Test de ARN sur des NUplets d'entiers
...
# Farnique le fichier in de recherche
mk_f_rech(){
...
commande="./main_ARN -c @1 @2 $f_in"

# Pattern de la commande de vérification
verif="$0 -t $f_in $f_out" 
...
# Pattern de la commande de test
commande="./main_ARN -g @1 @2 $f_in $f_in2"
...
# Pattern de la commande de test
commande="./main_ARN -h @1 @2 $f_in $f_in2"
...
# Pattern de la commande de test
commande="./main_ARN -i @1 @2 $f_in $f_in2"
...
commande="./main_ARN -r @1 @2 $f_in $f_in2"
verif="cmp $f_in $f_out" 
